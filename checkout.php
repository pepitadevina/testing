...
// jika belum login maka dilarikan ke login.php
	...
	<div class="container">
		...
		<form method="post">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="form-group">
						<input type="text" readonly value="<?php echo $_SESSION["pelanggan"]['notelp_pelanggan'] ?>" class="form-control">
					</div>
				</div>
				<div class="col-md-4">
			...
			<button class="btn btn-danger" name="checkout">checkout</button>
		</form>
		...
		if (isset($_POST["checkout"]))
		{
			...
			foreach ($_SESSION["keranjang"] as $id_produk => $jumlah)
			{
				...
				// mendapatkan data produk bdskan id_produk
			...
			// tampilan dialihkan ke halaman nota pembelian tsb
			echo "<script>alert('pembelian produk sukses'); </script>";
